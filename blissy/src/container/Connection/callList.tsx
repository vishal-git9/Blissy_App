...
const CallListScreen: React.FC<NavigationStackProps> = ({navigation}) => {
  const renderChatItem = ({item}: {item: Chat}) => (
    <TouchableOpacity
      ...
      <View style={{flexDirection: 'row', columnGap: actuatedNormalize(10)}}>
        ...
        />
        <RoundedIconContainer
          iconStyles={{width: actuatedNormalize(45), height: actuatedNormalize(45), borderRadius: actuatedNormalize(30)}}
          size={actuatedNormalize(18)}
